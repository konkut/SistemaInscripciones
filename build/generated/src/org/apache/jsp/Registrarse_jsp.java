...
public final class Registrarse_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                <h1 class=\"badge bg-danger\" >Registrarse</h1>\n");
      out.write("                <form class=\"form-group\" method=\"get\" action=\"InsSigIn\">\n");
      out.write("                    <input type=\"text\" name=\"usuario\" value=\"");
if(request.getParameter("SignIn")!=null){user = request.getParameter("usuario");}
      out.print(user);
      out.write("\" class=\"form-control mb-3\" placeholder=\"Ingresa un nombre de usuario\"/>\n");
      out.write("                    <input type=\"text\" name=\"contrasena\" value=\"");
if(request.getParameter("SignIn")!=null){pass = request.getParameter("contrasena");}
      out.print(pass);
      out.write("\" class=\"form-control mb-3\" placeholder=\"Introduce una contraseña\"/>\n");
      out.write("                    <input class=\"btn btn-success btn-block\" type=\"submit\" name=\"SignIn\" value=\"REGISTRARSE\"/>\n");
      out.write("                    <input class=\"btn btn-danger btn-block\" type=\"submit\" name=\"SignIn\" value=\"INICIARSESION\"/>\n");
      out.write("                    ");
      ...
      out.write("\n");
      out.write("                                    <div class=\"alert alert-danger mt-2\">INGRESE UN NOMBRE DE USUARIO PORFAVOR!!</div>\n");
      out.write("                                   ");

                            }else if(request.getParameter("contrasena").trim().equals("")){
                                
      out.write("\n");
      out.write("                                    <div class=\"alert alert-danger mt-2\">INGRESA UN CONTRASEÑA PORFAVOR!!</div>\n");
      out.write("                                    ");
